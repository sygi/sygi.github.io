...
<figure>
![An example mel-spectrogram. Note a region of lower energy after around 130 time units, which corresponds to a pause in the sound wave.](../images/tts/mel-spectrogram.jpg){width=30%}
</figure>
...
<figure>
![A high-level diagram describing architecture of the text-to-speech models.](../images/tts/diagram.jpg){width=90%}
</figure>
