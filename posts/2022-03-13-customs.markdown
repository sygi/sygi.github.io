...
![Nie wnikajmy, czemu paczka została przeniesiona do Lublina skoro docelowy adres jest bliżej Warszawy, w mazowieckim.](../images/customs/map_ann.png){width=80%}
...
![Oświadczenie, które trzeba kliknąć przed wysłaniem reklamacji do Poczty Polskiej.](../images/customs/oswiadczenie_reklamacja.png){width=100%}
...
![Sposób opisu listy parametów w oficjalnej specyfikacji XML.](../images/customs/itemizowanie.png){width=35%}
...
![Komentarz do opinii o poczcie.](../images/customs/komentarz_pp.png){width=60%}
